...
import { subscribeStaffToPush } from './staffApi.js'
...
// key fetch is inlined directly for the same reason — no cross-portal
// module sharing, even for a one-line GET.
...
// OTHER-category opt-in/opt-out toggle is a separate, later preference
// that never touches this at all.
export function usePushSubscription() {
  ...
  async function subscribe() {
    ...
    try {
      ...
      await subscribeStaffToPush(subscription.toJSON())
      return true
    } catch (err) {
